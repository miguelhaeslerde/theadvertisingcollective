...
export default function Home() {
  return (
    <Layout>
      ...
      {/* Section with Customer Logos and Diagonal Banner */}
      <div className="relative">
        <CustomerLogos />
        
        {/* Customer Logos Diagonal Banner - UNSERE KUNDEN */}
        <div className="absolute -bottom-2 left-0 right-0 bg-accent-yellow transform -skew-y-2 py-8 overflow-hidden z-[9999] h-20">
      ...
      {/* Section with TOP 3 and Diagonal Banner */}
      <div className="relative">
        <TopThreeSection />
        
        {/* Diagonal Divider - TAC Text */}
        <div className="absolute -bottom-2 left-0 right-0 bg-accent-yellow transform skew-y-2 py-3 overflow-hidden z-[9999] h-12">
          <div className="relative">
